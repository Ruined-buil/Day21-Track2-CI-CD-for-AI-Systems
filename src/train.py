...
# Tu dong cau hinh MLflow de dam bao ket qua luon luu vao sqlite
ABS_PATH = os.path.abspath(os.getcwd()).replace("\\", "/")
os.environ["MLFLOW_TRACKING_URI"] = f"sqlite:///{ABS_PATH}/mlflow.db"
os.environ["MLFLOW_ARTIFACT_ROOT"] = f"file:///{ABS_PATH}/mlartifacts"
